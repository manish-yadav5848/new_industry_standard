select
    ...
    coalesce(M.participant_id, '-9999') as participant_id,
...
from
    (
        ...
        from
            ...
            and coalesce(pr.participant_id, '-9999') = coalesce(M1.participant_id, '-9999')
            left outer join (
                SELECT
                    plan_number,
                    participant_id,
            ...
            and coalesce(M3.participant_id, '-9999') = coalesce(M1.participant_id, '-9999')
    ) M